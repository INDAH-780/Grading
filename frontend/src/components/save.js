...
//proctoring features
useEffect(() => {
  const proctoring = new ProctoringLibrary({
...
//     if (key === "minTime" && !isMet) {
//       message = "You didn't meet the minimum sitting time requirement.";
//     } else if (key === "maxTime" && !isMet) {
//       message =
//         "You exceeded the maximum sitting time. Your exam will be submitted in 2 seconds.";
//     } else if (
//       key === "minTime" &&
//       constraintChecks.minTime &&
//       constraintChecks.maxTime
//     ) {
//       message = "Your sitting time is within the required range.";
//     } else if (!isMet) {
//       switch (key) {
//         case "wordCount":
//           message = "You didn't meet the specified word count.";
//           break;
//         case "characterCount":
//           message = "You didn't meet the specified character count.";
//           break;
//         default:
//           message = `${key.replace(/([A-Z])/g, " $1")}: ✗`;
//       }
//     } else if (key === "wordCount" || key === "characterCount") {
//       message = `${key.replace(/([A-Z])/g, " $1")}: ✓`;
//     }
